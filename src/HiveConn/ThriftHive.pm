...
use Types;
use ThriftHiveMetastore;

# HELPER FUNCTIONS AND STRUCTURES

package ThriftHive_execute_args;
use base qw(Class::Accessor);
ThriftHive_execute_args->mk_accessors( qw( query ) );
...
package ThriftHive_execute_result;
use base qw(Class::Accessor);
ThriftHive_execute_result->mk_accessors( qw( ) );
  ...
  while (1) 
  {
    ...
    SWITCH: for($fid)
    {
      /^1$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{ex} = new HiveServerException();
...
package ThriftHive_fetchOne_args;
use base qw(Class::Accessor);
...
package ThriftHive_fetchOne_result;
use base qw(Class::Accessor);
ThriftHive_fetchOne_result->mk_accessors( qw( success ) );
...
package ThriftHive_fetchN_args;
use base qw(Class::Accessor);
ThriftHive_fetchN_args->mk_accessors( qw( numRows ) );
...
package ThriftHive_fetchN_result;
use base qw(Class::Accessor);
ThriftHive_fetchN_result->mk_accessors( qw( success ) );
...
package ThriftHive_fetchAll_args;
use base qw(Class::Accessor);
...
package ThriftHive_fetchAll_result;
use base qw(Class::Accessor);
ThriftHive_fetchAll_result->mk_accessors( qw( success ) );
...
package ThriftHive_getSchema_args;
use base qw(Class::Accessor);
...
package ThriftHive_getSchema_result;
use base qw(Class::Accessor);
ThriftHive_getSchema_result->mk_accessors( qw( success ) );
...
package ThriftHive_getThriftSchema_args;
use base qw(Class::Accessor);
...
package ThriftHive_getThriftSchema_result;
use base qw(Class::Accessor);
ThriftHive_getThriftSchema_result->mk_accessors( qw( success ) );
...
package ThriftHive_getClusterStatus_args;
use base qw(Class::Accessor);
...
package ThriftHive_getClusterStatus_result;
use base qw(Class::Accessor);
ThriftHive_getClusterStatus_result->mk_accessors( qw( success ) );
...
sub read {
  ...
  while (1) 
  {
    ...
    {
      /^0$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{success} = new HiveClusterStatus();
        $xfer += $self->{success}->read($input);
      } else {
        $xfer += $input->skip($ftype);
      }
...
package ThriftHive_getQueryPlan_args;
use base qw(Class::Accessor);
...
package ThriftHive_getQueryPlan_result;
use base qw(Class::Accessor);
ThriftHive_getQueryPlan_result->mk_accessors( qw( success ) );
...
package ThriftHiveRest;

use strict;
use base qw(ThriftHiveMetastoreRest);
...
package ThriftHiveClient;

use base qw(ThriftHiveMetastoreClient);
use base qw(ThriftHiveIf);
sub new {
...
sub send_execute{
  ...
  my $args = new ThriftHive_execute_args();
  $args->{query} = $query;
...
sub recv_execute{
  ...
  my $result = new ThriftHive_execute_result();
...
sub send_fetchOne{
  ...
  my $args = new ThriftHive_fetchOne_args();
  $args->write($self->{output});
  $self->{output}->writeMessageEnd();
  $self->{output}->getTransport()->flush();
}
...
sub recv_fetchOne{
  ...
  my $result = new ThriftHive_fetchOne_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
...
sub send_fetchN{
  ...
  my $args = new ThriftHive_fetchN_args();
...
sub recv_fetchN{
  ...
  my $result = new ThriftHive_fetchN_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
...
sub send_fetchAll{
  ...
  my $args = new ThriftHive_fetchAll_args();
  $args->write($self->{output});
  $self->{output}->writeMessageEnd();
  $self->{output}->getTransport()->flush();
}
...
sub recv_fetchAll{
  ...
  my $result = new ThriftHive_fetchAll_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
...
sub send_getSchema{
  ...
  my $args = new ThriftHive_getSchema_args();
  $args->write($self->{output});
  $self->{output}->writeMessageEnd();
  $self->{output}->getTransport()->flush();
}
...
sub recv_getSchema{
  ...
  my $result = new ThriftHive_getSchema_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
...
sub send_getThriftSchema{
  ...
  my $args = new ThriftHive_getThriftSchema_args();
  $args->write($self->{output});
  $self->{output}->writeMessageEnd();
  $self->{output}->getTransport()->flush();
}
...
sub recv_getThriftSchema{
  ...
  my $result = new ThriftHive_getThriftSchema_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
...
sub send_getClusterStatus{
  ...
  my $args = new ThriftHive_getClusterStatus_args();
  $args->write($self->{output});
  $self->{output}->writeMessageEnd();
  $self->{output}->getTransport()->flush();
}
...
sub recv_getClusterStatus{
  ...
  my $result = new ThriftHive_getClusterStatus_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
...
sub send_getQueryPlan{
  ...
  my $args = new ThriftHive_getQueryPlan_args();
  $args->write($self->{output});
  $self->{output}->writeMessageEnd();
  $self->{output}->getTransport()->flush();
}
...
sub recv_getQueryPlan{
  ...
  my $result = new ThriftHive_getQueryPlan_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
...
package ThriftHiveProcessor;

use strict;
use base qw(ThriftHiveMetastoreProcessor);
...
sub process_execute {
    ...
    }; if( UNIVERSAL::isa($@,'HiveServerException') ){ 
      $result->{ex} = $@;
    }
